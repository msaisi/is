...
class Gradstate_class_types_model extends Base_module_model 
{	
	...
	{
		parent::__construct('gradstate_class_types', GRADSTATE_FOLDER);
	}	
	...
	function filters()
	{
	   $filters['name'] = array('label'=>'Class Type');
