...
class Gradstate_institution_types_model extends Base_module_model 
{	
	...
	{
		parent::__construct('gradstate_institution_types', GRADSTATE_FOLDER);
	}
	function filters()
	{
	   $filters['name'] = array('label'=>'Institution Type');
