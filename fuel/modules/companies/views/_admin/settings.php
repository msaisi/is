<div id="fuel_notification_extra" class="notification">
	<?php if ($warn_using_config) : ?>
			<div class="warning ico ico_warn">The siteconfig is currently using a configuration file to control the settings. 
...
<div id="fuel_main_content_inner">
	...
	<p class="instructions">
		Configure Buymore site configuration settings below:
	</p>
