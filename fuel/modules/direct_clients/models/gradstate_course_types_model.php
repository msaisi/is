...
class Gradstate_course_types_model extends Base_module_model 
{	
	...
	{
		parent::__construct('gradstate_course_types', GRADSTATE_FOLDER);
	}	
	...
	function filters()
	{
	   $filters['name'] = array('label'=>'Course Type');
